...
HOSTNAME=$(hostname)
METATRON_NAME="discovery"
METATRON_LOGFILE="${METATRON_LOG_DIR}/discovery-${METATRON_IDENT_STRING}-${HOSTNAME}.log"
METATRON_OUTFILE="${METATRON_LOG_DIR}/discovery-${METATRON_IDENT_STRING}-${HOSTNAME}.out"
METATRON_PID="${METATRON_PID_DIR}/discovery-${METATRON_IDENT_STRING}-${HOSTNAME}.pid"
